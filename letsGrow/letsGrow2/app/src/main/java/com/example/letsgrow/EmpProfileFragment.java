...
public class EmpProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_emp_profile, container, false);
        firebaseAuth = FirebaseAuth.getInstance();

        ename = v.findViewById(R.id.ename);

        meet3 = v.findViewById(R.id.meet3);
        MessageFragment = new MessageFragment();

        meet3.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        recyclerView = v.findViewById(R.id.view4);
