...
public class ProfileFragment extends Fragment {
    ...
    String id,name;
    TextView iname;
    ImageView meet,pitch;
    Fragment MessageFragment,PitchFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        iname = v.findViewById(R.id.iname);
        meet = v.findViewById(R.id.meet1);
        pitch = v.findViewById(R.id.pitch);
        ...
        recyclerView = v.findViewById(R.id.view2);
